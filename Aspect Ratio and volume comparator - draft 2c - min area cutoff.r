...
setwd("E:/Garg Lab/Output2/Final Figure")
...
createBoxplot(fileNameList, allAspectRatioMatrix, "Aspect Ratio Distribution", "", FALSE, c(0,5))
createBoxplot(fileNameList, allAreaMatrix, expression(paste(plain("Graphene Particle Bounding Box Area (μm") ^ plain(" 2"), plain(")"))), "y", FALSE, c(2, 50))
